const SystemGB = () => {
  return (
    <div>
      <div className="systemGB-title">Sistema GB</div>
      <div className="systemGB-ml systemGB systemGB-center">
        <div className="systemGB-col">
          ...
          <p>
            ...
            e avançado. Particularmente o currículo GB1 tem tido um resultado
            expetacular no papel e apresentar e transmitir os fundamentos do
            Jiu-Jitsu para o novo praticante.
          </p>
        </div>
        <div className="systemGB-col">
          ...
          <p>
            ...
            Jiu-Jitsu deve ser abordado enquanto arte marcial, mesmo sendo a sua
            prática voltada para o desporto na maior parte do tempo. Assim,
            buscamos manter todos os benefícios da prática de uma arte marcial,
            desde a transmissão de valores como honra, irmandade, honestidade e
            hierarquia, ao foco na eficiência da arte marcial enquanto
        ...
        <div className="systemGB-col">
          ...
          <p>
            ...
            estabelecido pela Gracie Barra.
          </p>
        </div>
      </div>
    </div>
